...
CREATE TABLE INFOMATION (
    ...
    IPARKNAME VARCHAR2(50) NOT NULL,
    ITYPE VARCHAR2(50),
...
-- dummy data
INSERT INTO INFOMATION (INO, AID, IPARKNAME, ITYPE, ITITLE, ITEXT)
    VALUES (INFOMATION_SQ.NEXTVAL, 'admin', '지리산공원', '타입', '제목', '본문');
INSERT INTO INFOMATION (INO, AID, IPARKNAME, ITYPE, ITITLE, ITEXT)
    VALUES (INFOMATION_SQ.NEXTVAL, 'admin', '한라산공원', '유형', '제목2', '본문2');
INSERT INTO INFOMATION (INO, AID, IPARKNAME, ITYPE, ITITLE, ITEXT)
    VALUES (INFOMATION_SQ.NEXTVAL, 'admin', '관악산', '유형', '제목3', '본문3');
INSERT INTO INFOMATION (INO, AID, IPARKNAME, ITYPE, ITITLE, ITEXT)
    VALUES (INFOMATION_SQ.NEXTVAL, 'admin', '구름산', '타입', '제목4', '본문4');
...
-- 글 작성 id = infoInsert
INSERT INTO INFOMATION (INO, AID, IPARKNAME, ITYPE, ITITLE, ITEXT)
    VALUES (INFOMATION_SQ.NEXTVAL, 'admin', '화산', '타입', '제목4', '본문5');

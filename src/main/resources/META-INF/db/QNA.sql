...
INSERT INTO QNA (QNO, ID, AID, PARKNAME, QTYPE, QTITLE, QTEXT, QRDATE, QYN, QSTATUS, QGROUP, QSTEP, QINDENT, QIP)
    VALUES(QNA_SQ.NEXTVAL, 'bbb', 'admin', '지리산공원', '유형','비제목', '비본문', SYSDATE, 'y',  1, QNA_SQ.CURRVAL, 0, 0, '192.30.');
INSERT INTO QNA (QNO, ID, AID, PARKNAME, QTYPE, QTITLE, QTEXT, QRDATE, QYN, QSTATUS, QGROUP, QSTEP, QINDENT,  QIP)
    VALUES(QNA_SQ.NEXTVAL, 'ccc', 'admin', '한라산', '유형','시제목2', '시본문', SYSDATE, 'n',  1, QNA_SQ.CURRVAL, 0, 0, '192.30.1.100');
INSERT INTO QNA (QNO, ID, AID, PARKNAME, QTYPE, QTITLE, QTEXT, QRDATE, QYN, QSTATUS, QGROUP, QSTEP, QINDENT, QIP)
    VALUES(QNA_SQ.NEXTVAL, 'ddd', 'admin', '백두산', '유형','디제목', '디본문', SYSDATE, 'n',  1, QNA_SQ.CURRVAL, 0, 0, '192.30.1.109');
INSERT INTO QNA (QNO, ID, AID, PARKNAME, QTYPE, QTITLE, QTEXT, QRDATE, QYN, QSTATUS, QGROUP, QSTEP, QINDENT, QIP)
    VALUES(QNA_SQ.NEXTVAL, 'eee', 'admin', '관악산', '유형','이제목', '이본문', SYSDATE, 'n',  1, QNA_SQ.CURRVAL, 0, 0, '192.30.2');

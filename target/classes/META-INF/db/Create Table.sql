...
--ALTER TABLE MEMBER ADD MAIL_AUTH NUMBER(5) DEFAULT 0 NOT NULL;
--ALTER TABLE MEMBER ADD MAIL_KEY VARCHAR2(50);
-- 
--ALTER TABLE MEMBER DROP COLUMN MAIL_AUTH; 
--ALTER TABLE MEMBER DROP COLUMN MAIL_KEY;
